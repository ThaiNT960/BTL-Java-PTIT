        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <table class="w-full">
                ...
                <tr>
                    ...
                    <th class="px-4 py-2 text-left text-sm font-semibold">Tồn kho</th>
    ...
    <div id="stats-tab" class="tab-content hidden">
        <div class="grid grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-3xl font-bold" id="bestSelling">-</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-gray-600 text-sm mb-2">Doanh thu</div>
                <div class="text-3xl font-bold" id="totalRevenue">0 VNĐ</div>
            </div>
        </div>
    </div>
</div>
...
<div id="productModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <form id="productForm" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-semibold mb-2">Tồn kho</label>
