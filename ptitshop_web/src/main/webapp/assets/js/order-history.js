...
async function openOrderDetail(id, code) {
    try {
      ...
      <div class="mt-4 text-sm">
        ...
        let cancelBtn = '';
        const nonCancellableStates = ['canceled', 'delivered', 'shipped'];

        if (!nonCancellableStates.includes(normalizeStatus(o.status).key)) {
            cancelBtn = `
      <div class="mt-6 text-right">
        ...
        document.getElementById('orderDetailBody').innerHTML += cancelBtn;
