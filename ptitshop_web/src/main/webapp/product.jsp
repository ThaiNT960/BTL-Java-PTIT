...
<div class="px-6 py-4 border-b border-gray-200">
    <div class="max-w-7xl mx-auto">
        <a href="home" class="text-gray-600 hover:text-black">Trang chủ</a>
...
<!-- Mini Cart -->
<div id="miniCart"
     class="fixed top-5 right-5 bg-white border border-gray-200 rounded-xl shadow-lg p-5 min-w-[300px] z-50 flex flex-col max-h-[60vh]">
    <div class="flex justify-between items-center mb-4">
